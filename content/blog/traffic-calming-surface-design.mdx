...
## Compliance and Snowplow Compatibility

Surface-based traffic calming maintains zero-elevation-change compliance under and equivalent provincial standards — an area where physical raised tables can introduce accessible route complications at their asphalt transitions.
