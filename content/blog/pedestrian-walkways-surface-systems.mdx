...
StreetBond bonds to existing asphalt without surface removal. It adds no measurable elevation change — zero trip hazard, full accessibility standards compliance. It accepts standard road marking thermoplastics over the coating for directional arrows, distance markers, and accessibility symbols.
