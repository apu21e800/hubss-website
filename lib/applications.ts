...
export const applications: Application[] = [
  ...
  },
  {
    ...
    shortDesc: "Coloured intersection treatments and surface cues engineered to reduce vehicle speeds.",
    ...
    description: [
      "Traffic calming converts driver behaviour through design — and pavement surface treatments are among the most cost-effective tools available. Coloured intersection treatments, high-contrast gateway markings, and stamped asphalt patterns all communicate to drivers that they have entered a zone requiring reduced speed.",
      "StreetPrint stamped asphalt creates a visual and textural distinction at key locations — school zones, neighbourhood gateways, shared-use corridors — signalling priority to both drivers and pedestrians.",
    ],
    relatedProducts: ["traffic-patterns-xd", "traffic-patterns", "streetprint"],
    benefits: [
