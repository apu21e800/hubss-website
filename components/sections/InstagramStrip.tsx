      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-14 gap-6">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold" style={{ color: "#ffffff" }}>Follow the Work</h2>
            <p className="mt-3 text-base" style={{ color: "rgba(255,255,255,0.45)" }}>Projects across Canada — documented as they happen.</p>
          </div>
          ...
          {SOCIAL_CHANNELS.map((ch) => (
            <a key={ch.name} href={ch.href} target="_blank" rel="noopener noreferrer"
              ...
              <div className="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 transition-colors group-hover:bg-orange-500/15"
                style={{ background: "rgba(255,255,255,0.06)", color: "rgba(255,255,255,0.5)" }}>{ch.icon}</div>
              <div className="min-w-0">
                ...
                <p className="text-xs truncate" style={{ color: "rgba(255,255,255,0.50)" }}>{ch.desc}</p>
              </div>
