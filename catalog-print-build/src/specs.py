...
# registered with ReportLab via register_inter_fonts() (called once at
# module import below). Brings print into parity with the website +
# Figma plugin which already use Inter. Inter-Light/Thin intentionally
# NOT registered (Vernon rejects thin weights). No serif anywhere.
FONT_SANS_REG     = "Inter"
...
# Backward-compat alias — legacy code may still reference FONT_SERIF for
# italic emphasis. Map to Inter-Italic (no actual serif anywhere).
