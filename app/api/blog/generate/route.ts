...
const BLOG_TOPICS = [
  ...
  "Airport surface markings: AirMark preformed thermoplastic for Canadian airports",
  ...
  "Accessible pedestrian surfaces: tactile indicators, high-contrast markings, and colour contrast",
