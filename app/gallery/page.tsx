...
const IMAGES: GalleryImage[] = [
  // ── Crosswalks ──────────────────────────────────────────────────────────────
  { src: "/images/blog/best-crosswalks-canada/best-crosswalks-canada.jpg", alt: "High-Visibility Crosswalk", category: "crosswalks", location: "Canada-Wide", tall: true },
  { src: "/images/blog/decorative-crosswalk-meridian/decorative-crosswalk-meridian.jpg", alt: "Decorative Crosswalk — Meridian", category: "crosswalks", location: "Meridian, ON" },
  { src: "/images/blog/decorative-asphalt-high-traffic/decorative-asphalt-high-traffic.jpg", alt: "High-Traffic Decorative Asphalt", category: "crosswalks", location: "Ontario" },
  { src: "/images/blog/complete-streets-new-westminster/complete-streets-new-westminster.jpg", alt: "Complete Streets", category: "crosswalks", location: "New Westminster, BC", tall: true },
  { src: "/images/blog/pedestrian-channelization-public-spaces/pedestrian-channelization-public-spaces.jpg", alt: "Pedestrian Channelization", category: "crosswalks", location: "British Columbia" },
  { src: "/images/blog/performance-crosswalks-asphalt-concrete/performance-crosswalks-asphalt-concrete.jpg", alt: "Performance Crosswalks", category: "crosswalks", location: "Canada" },
  { src: "/images/blog/trafficpatternsxd-urban-design/trafficpatternsxd-urban-design.jpg", alt: "TrafficPatternsXD Urban Design", category: "crosswalks", location: "Urban Canada", tall: true },
  { src: "/images/blog/stamped-asphalt-vs-concrete/stamped-asphalt-vs-concrete.jpg", alt: "Stamped Asphalt Crosswalk", category: "crosswalks", location: "Ontario" },
  { src: "/images/blog/decorative-asphalt-crosswalks/decorative-asphalt-crosswalks.jpg", alt: "Decorative Asphalt Crosswalks", category: "crosswalks", location: "British Columbia" },
  { src: "/images/blog/decorative-crosswalk-commercial-drive/decorative-crosswalk-commercial-drive.jpg", alt: "Commercial Drive Crosswalk", category: "crosswalks", location: "Vancouver, BC", tall: true },
  { src: "/images/blog/decorative-crosswalks-community-identity/decorative-crosswalks-community-identity.jpg", alt: "Community Identity Crosswalk", category: "crosswalks", location: "Canada" },
  { src: "/images/blog/decorative-hardscape-grey-is-new-black/decorative-hardscape-grey-is-new-black.jpg", alt: "Decorative Hardscape", category: "crosswalks", location: "Ontario" },
  { src: "/images/blog/municipalities-case-study/municipalities-case-study.jpg", alt: "Municipal Crosswalk", category: "crosswalks", location: "Ontario" },
  { src: "/images/blog/white-rock-langley-trafficpatterns/white-rock-langley-trafficpatterns.jpg", alt: "TrafficPatterns Installation", category: "crosswalks", location: "White Rock, BC", tall: true },
  { src: "/images/blog/keeping-pedestrians-safe/keeping-pedestrians-safe.png", alt: "Pedestrian Safety Crosswalk", category: "crosswalks", location: "Canada" },
  { src: "/images/blog/educational-facilities/educational-facilities.jpg", alt: "School Zone Crosswalk", category: "crosswalks", location: "British Columbia" },
  { src: "/images/blog/murrayville-schoolhouse-sidewalk/murrayville-schoolhouse-sidewalk.jpg", alt: "Murrayville Schoolhouse Sidewalk", category: "crosswalks", location: "Murrayville, BC" },
  { src: "/images/blog/transportation-infrastructure-guide/transportation-infrastructure-guide.jpg", alt: "Transportation Infrastructure", category: "crosswalks", location: "Canada", tall: true },
  ...
  // ── Bike & Bus Lanes ────────────────────────────────────────────────────────
  { src: "/images/blog/multimodal-connectivity-york-region/multimodal-connectivity-york-region.jpg", alt: "York Region Transit Corridor", category: "transit", location: "York Region, ON", tall: true },
  { src: "/images/blog/durable-transit-lanes-crossings/durable-transit-lanes-crossings.jpg", alt: "Durable Transit Lanes", category: "transit", location: "Ontario" },
  { src: "/images/blog/extending-transit-lane-lifespan/extending-transit-lane-lifespan.jpg", alt: "Bus Lane — Extended Lifespan", category: "transit", location: "Ontario" },
  { src: "/images/blog/imprinted-asphalt-york-transit/imprinted-asphalt-york-transit.jpg", alt: "York Region VIVA BRT", category: "transit", location: "York Region, ON", tall: true },
  { src: "/images/blog/safety-durability-transit-stations/safety-durability-transit-stations.jpg", alt: "Transit Station Surface", category: "transit", location: "Ontario" },
  { src: "/images/blog/streetbondsr-solar-reflective-coatings/streetbondsr-solar-reflective-coatings.jpg", alt: "StreetBondSR Bike Lane", category: "transit", location: "Canada" },
  ...
  // ── Community Branding ──────────────────────────────────────────────────────
  { src: "/images/blog/branded-crosswalks-vancouver-richmond/branded-crosswalks-vancouver-richmond.jpg", alt: "Branded Crosswalks", category: "community", location: "Vancouver, BC", tall: true },
  { src: "/images/blog/community-branding-case-study/community-branding-case-study.jpg", alt: "Community Branding", category: "community", location: "Ontario" },
  { src: "/images/blog/simcoe-rainbow-crosswalk/simcoe-rainbow-crosswalk.jpg", alt: "Rainbow Crosswalk", category: "community", location: "Simcoe, ON" },
  { src: "/images/blog/terry-fox-plaza-coquitlam/terry-fox-plaza-coquitlam.jpg", alt: "Terry Fox Plaza", category: "community", location: "Coquitlam, BC", tall: true },
  { src: "/images/blog/tsain-ko-crosswalk-sechelt/tsain-ko-crosswalk-sechelt.jpg", alt: "Tsain-Ko Crosswalk", category: "community", location: "Sechelt, BC" },
  { src: "/images/blog/pictograph-crosswalk-sechelt/pictograph-crosswalk-sechelt.jpg", alt: "Pictograph Crosswalk", category: "community", location: "Sechelt, BC" },
  { src: "/images/blog/ubc-musqueam-crosswalk/ubc-musqueam-crosswalk.jpg", alt: "UBC Musqueam Crosswalk", category: "community", location: "Vancouver, BC", tall: true },
  { src: "/images/blog/every-child-matters-crosswalk/every-child-matters-crosswalk.png", alt: "Every Child Matters Crosswalk", category: "community", location: "British Columbia" },
  { src: "/images/blog/laneway-project/laneway-project.png", alt: "Vancouver Laneway Project", category: "community", location: "Vancouver, BC" },
  { src: "/images/blog/white-rock-pier-crosswalk/white-rock-pier-crosswalk.png", alt: "White Rock Pier Crosswalk", category: "community", location: "White Rock, BC", tall: true },
  { src: "/images/blog/community-spaces/community-spaces.jpg", alt: "Community Space", category: "community", location: "British Columbia" },
  { src: "/images/blog/decorative-paving-solutions/decorative-paving-solutions.jpg", alt: "Decorative Paving", category: "community", location: "Canada" },
  ...
  // ── Parks & Paths ───────────────────────────────────────────────────────────
  { src: "/images/blog/spirit-trail-wayfinding-vancouver/spirit-trail-wayfinding-vancouver.jpg", alt: "Spirit Trail Wayfinding", category: "parks", location: "Vancouver, BC", tall: true },
  { src: "/images/blog/bowen-island-asphalt-path/bowen-island-asphalt-path.jpg", alt: "Bowen Island Path", category: "parks", location: "Bowen Island, BC" },
  { src: "/images/blog/parc-riviera-streetbond-walkway/parc-riviera-streetbond-walkway.jpg", alt: "Parc Riviera Walkway", category: "parks", location: "Quebec" },
  { src: "/images/blog/roadway-accents-natures-walk/roadway-accents-natures-walk.jpg", alt: "Nature Walk Accent", category: "parks", location: "Ontario", tall: true },
  ...
  // ── Recreation ──────────────────────────────────────────────────────────────
  { src: "/images/blog/bc-childrens-hospital-labyrinth/bc-childrens-hospital-labyrinth.jpg", alt: "BC Children's Hospital Labyrinth", category: "recreation", location: "Vancouver, BC", tall: true },
  { src: "/images/blog/durable-coatings-waterparks/durable-coatings-waterparks.jpg", alt: "Waterpark Surface Coating", category: "recreation", location: "Canada" },
  { src: "/images/blog/playgrounds-recreation/playgrounds-recreation.jpg", alt: "Playground Surface", category: "recreation", location: "Canada" },
  ...
  // ── Parking ─────────────────────────────────────────────────────────────────
  { src: "/images/blog/stamped-asphalt-parking-lot/stamped-asphalt-parking-lot.jpg", alt: "Stamped Asphalt Parking Lot", category: "parking", location: "Ontario", tall: true },
  { src: "/images/blog/commercial-applications/commercial-applications.jpg", alt: "Commercial Pavement", category: "parking", location: "Canada" },
