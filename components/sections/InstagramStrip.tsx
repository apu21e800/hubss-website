    ...
    <section className="py-20 bg-black border-t border-zinc-800">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-4">
          <div>
            <p className="text-zinc-500 text-xs uppercase tracking-widest mb-2">On The Ground</p>
        ...
        {/* Instagram grid placeholder — replace with real embed when API token is available */}
