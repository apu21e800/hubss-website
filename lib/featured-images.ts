...
export const productImages: Record<string, ImageConfig> = {
  ...
  'streetbond': { featured: null, fallback: '/images/products/streetbond/streetbond-01.png', alt: 'StreetBond coloured acrylic pavement coating — bike lane and crosswalk application' },
...
export const applicationImages: Record<string, ImageConfig> = {
  ...
  'residential-driveways': { featured: '/images/applications/residential-driveways/residential-driveways-03.jpg', fallback: '/images/applications/residential-driveways/residential-driveways-03.jpg', alt: 'Residential stamped asphalt driveway — aerial view of StreetPrint circular pattern in front of home with garage' },
