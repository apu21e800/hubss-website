...
export const products: Product[] = [
  ...
  },
  {
    name: "DuraShield",
    slug: "durashield",
    shortDesc: "Pavement maintenance coating. Maintain a surface instead of replacing it.",
