...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/surface-system-solutions-for-school-playgrounds", destination: "/applications/playgrounds", permanent: true },
      { source: "/decorative-asphalt-for-communities", destination: "/blog/community-branding-case-study", permanent: true },
      { source: "/asphalt-coatings-for-parks-and-plazas", destination: "/applications/parks-paths", permanent: true },
      { source: "/streetbondsr-for-cooler-asphalt-surfaces", destination: "/blog/streetbondsr-solar-reflective-coatings", permanent: true },
      { source: "/enhancing-transit-hubs-in-the-gta-and-metro-vancouver", destination: "/blog/safety-durability-transit-stations", permanent: true },
      ...
      { source: "/decorative-asphalt-for-rutland-centennial-park-kelowna", destination: "/applications/parks-paths", permanent: true },
      { source: "/societe-de-transport-du-saguenay", destination: "/blog/durable-transit-lanes-crossings", permanent: true },
      { source: "/bikeway-intersection", destination: "/applications/bike-lanes", permanent: true },
      { source: "/decorative-asphalt-renewal", destination: "/blog/asphalt-concrete-renewal", permanent: true },
      { source: "/asphalt-coatings-for-playgrounds", destination: "/applications/playgrounds", permanent: true },
      { source: "/west-vancouver-rainbow-crosswalk", destination: "/blog/simcoe-rainbow-crosswalk", permanent: true },
      { source: "/ackerys-alley-decorative-asphalt-orpheum-theatre-laneway", destination: "/blog/laneway-project", permanent: true },
      { source: "/decorative-paving-stamped-asphalt-after-2-years-wear", destination: "/blog/stamped-asphalt-vs-concrete", permanent: true },
      { source: "/ralphs-farm-market-decorative-asphalt-parking-lot", destination: "/applications/parking-lots", permanent: true },
      ...
      { source: "/squamish-nation-rainbow-crosswalk", destination: "/blog/simcoe-rainbow-crosswalk", permanent: true },
      { source: "/melfort-saskatchewan-waterpark-splash-pad", destination: "/applications/splash-pads", permanent: true },
      { source: "/victoria-harbor-decorative-asphalt-walkway", destination: "/applications/parks-paths", permanent: true },
      { source: "/sports-court-asphalt-paving", destination: "/applications/sport-courts", permanent: true },
      { source: "/rainbow-crosswalk-sechelt", destination: "/blog/simcoe-rainbow-crosswalk", permanent: true },
      { source: "/white-rock-stamped-asphalt-pathway", destination: "/blog/white-rock-langley-trafficpatterns", permanent: true },
      { source: "/checkerboard-decorative-asphalt-crosswalk", destination: "/applications/crosswalks", permanent: true },
      { source: "/first-nations-decorative-crosswalk-design-granville-street", destination: "/blog/ubc-musqueam-crosswalk", permanent: true },
      { source: "/lickman-interchange-decorative-asphalt-roundabout", destination: "/applications/traffic-calming", permanent: true },
      { source: "/stamped-asphalt-streetscapes-viva-next", destination: "/blog/durable-transit-lanes-crossings", permanent: true },
      { source: "/decorative-paving-for-townhomes-canada", destination: "/applications/townhomes", permanent: true },
      { source: "/decorative-paving-public-art", destination: "/applications/public-art", permanent: true },
      ...
      { source: "/residential-decorative-paving", destination: "/applications/residential-driveways", permanent: true },
      { source: "/laneway-revitalization", destination: "/blog/laneway-project", permanent: true },
      { source: "/residential-decorative-driveways", destination: "/applications/residential-driveways", permanent: true },
      { source: "/decorative-paving-for-playgrounds", destination: "/applications/playgrounds", permanent: true },
      { source: "/parking-lot-wayfinding", destination: "/applications/parking-lots", permanent: true },
      { source: "/durable-coatings-for-asphalt", destination: "/blog/durable-coatings-waterparks", permanent: true },
      { source: "/stamped-asphalt-decorative-crosswalks", destination: "/applications/crosswalks", permanent: true },
      { source: "/enhanced-parking-lot-surfaces", destination: "/applications/parking-lots", permanent: true },
      ...
      { source: "/projects/decorative-paving-public-art", destination: "/applications/public-art", permanent: true },
      { source: "/projects/decorative-paving-for-townhomes-canada", destination: "/applications/townhomes", permanent: true },
