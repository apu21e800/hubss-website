    ...
    defineField({
      ...
      of: [{
        ...
        fields: [
          ...
          defineField({ name: "fileAsset",   type: "file",   title: "PDF file (Sanity CDN)", description: "Upload the PDF here — preferred over fileUrl once migrated" }),
          defineField({ name: "fileUrl",     type: "string", title: "File path (legacy)", description: "Fallback path relative to /public — keep until fileAsset is set" }),
