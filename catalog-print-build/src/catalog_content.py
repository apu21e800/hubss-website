...
PRODUCTS = [
    {"name": "TrafficPatternsXD",
     ...
     "body": "150-mil aggregate-reinforced preformed thermoplastic. BPN 65+ skid resistance under live bus traffic and turning loads. Heat-fused permanently — no annual maintenance cycle.",
    ...
    {"name": "TrafficPatterns",
     ...
     "body": "125-mil preformed thermoplastic, heat-fused with full-depth retroreflective glass beads. Outlasts paint by seasons. Open to traffic within hours of installation.",
    ...
    {"name": "StreetBond",
     ...
     "body": "Flexible acrylic engineered to move with the asphalt — will not peel, crack, or chalk. Full custom Pantone matching. BC Ministry of Transportation recognized.",
    ...
    {"name": "StreetPrint",
     ...
     "body": "In-place stamped asphalt in 12+ patterns, sealed with StreetBond UV-stable colour. Flush with the road: no raised edges, no shear risk under snowplows, no joints to weed.",
    ...
    {"name": "DecoMark",
     ...
     "body": "Custom preformed thermoplastic fabricated to your vector artwork and Pantone colour. Heat-fused to asphalt or concrete. Pride crosswalks, Indigenous cultural art, civic murals — permanent.",
    ...
    {"name": "MMAX",
     ...
     "body": "MMA resin — cures in 45–60 minutes, traffic-ready before the overnight window closes. Applies at +3°C. Bond strength above 3 MPa. Outlasts painted and acrylic alternatives by seasons.",
    ...
    {"name": "StreetBondSR",
     ...
     "body": "Solar reflective acrylic — Initial SRI ≥ 0.33, meeting the LEED v4 SS Credit: Heat Island Reduction threshold. Same adhesion and flexibility as StreetBond. Reduces surface temperature.",
    ...
    {"name": "DuraTherm",
     ...
     "body": "Preformed thermoplastic inlaid into a milled groove — flush with the road, zero raised edges. No shear risk for plow blades. No trip hazard. Decorative and durable.",
    ...
    {"name": "DuraShield",
     ...
     "body": "Epoxy-modified acrylic maintenance coating. Solar Reflectance 0.34. Chemical-resistant: fuel, oil, deicing agents. Anti-slip aggregate available. Low VOC.",
    ...
    {"name": "PreMark",
     ...
     "body": "Preformed thermoplastic road marking symbols — arrows, stop bars, bike pictographs, school legends. 125mil standard. Heat-applied, open to traffic immediately. No stencils, no curing window.",
    ...
    {"name": "AirMark",
     ...
     "body": "Preformed thermoplastic for non-runway airfield surfaces. Certified to airfield marking standards. Full-depth glass bead retroreflectivity. Service life 4× paint. Applied by certified crews.",
