...
export const products: Product[] = [
  // ── Flagship Group ────────────────────────────────────────────────────────────────────────
  {
    ...
    description: "TrafficPatternsXD: 150mil aggregate-reinforced thermoplastic for BRT corridors and high-volume intersections. BPN 65+ skid resistance built to outlast paint season after season.",
    specs: [
  ...
  },
  {
    ...
    description: "Crisp, permanently fused markings that survive snowplows, de-icing chemicals, and decades of freeze-thaw cycles — that's what TrafficPatterns delivers. Factory-manufactured to 90mil thickness. Delivers consistent retroreflectivity season after season where traffic paint needs annual repainting.",
    specs: [
  ...
  },
  {
    ...
    description: "DuraTherm: inlaid flush-mount thermoplastic. Zero raised edges, zero profile for plow blades. Survives winter maintenance season after season — no repainting, no replacement cycles.",
    specs: [
  ...
  },
  {
    ...
    description: "DuraShield penetrating asphalt rejuvenator and protective seal coat. Documented lifespan extension at a fraction of replacement cost.",
    specs: [
