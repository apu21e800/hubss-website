    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* Theme — Dark · Mixed · Light. Lives here rather than in the bar:
                a third control in the bar pushed the hamburger off a 390px screen. */}
            <div className="flex items-center justify-between gap-3 mb-3">
              <span className="text-[11px] font-bold tracking-[0.18em] uppercase" style={{ color: "var(--ink-55)" }}>Theme</span>
              <ThemeToggle compact />
            </div>
            {/* Regional phones */}
...
export default function Nav() {
  ...
  return (
    <>
      {/* The nav is dark in every theme: the orange-on-charcoal wordmark is
          the brand, and a dark bar + dark footer frame the light page. */}
      <nav
        ref={navRef}
        data-surface="dark"
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex items-center gap-2">
            {/* Theme switch — Dark · Mixed · Light. Review-build control; see
                components/ui/ThemeToggle.tsx for what each mode means. */}
            <div className="mr-1">
              <ThemeToggle compact />
            </div>
