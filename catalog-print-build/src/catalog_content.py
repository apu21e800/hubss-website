...
PRODUCTS = [
    ...
    {"name": "ChipFill",
     "category": "Heat-Activated Pothole Repair",
     "tagline": "Patch potholes year-round, in any weather.",
     "hero": _pick(PRODUCTS_DIR / "chipfill" / "chipfill-road-repair.webp",
                   PRODUCTS_DIR / "chipfill" / "chipfill-02.jpg"),
     "title": "Heat-activated pothole repair.",
     "italic": "Preformed material. Propane torch. Year-round deployment.",
     "callout": "Minutes",
     "callout_unit": "From application to reopened lane — torch cure, no hot-mix plant required",
     "body": "ChipFill is a heat-activated preformed pothole repair material engineered for permanent restoration of road surface damage. Laid into the prepared excavation and activated with a propane torch — no specialised equipment, no hot-mix plant, no aggregate batching. Once heated, ChipFill conforms to the contours of the damage and bonds chemically to the surrounding asphalt or concrete, sealing the substrate from the water intrusion that turns minor defects into deep structural failures. Deployable year-round regardless of temperature — a critical advantage in Canadian climates where hot-mix plants close seasonally and potholes peak in early spring. Specified for routine patrol patching, emergency response, utility cut restoration, and edge joint repair.",
     "uses": ["Patrol Patching", "Utility Cuts", "Cracks", "Joints"],
     "spec_pairs": [("Type", "Heat-activated preformed"), ("Application", "Propane torch — no mixing"),
                    ("Substrate", "Asphalt and concrete"), ("Cure", "Minutes — open to traffic")]},
    {"name": "AggreFill",
     "category": "Aggregate Pothole Filler",
     "tagline": "Larger potholes. Permanent repair.",
     "hero": _pick(PRODUCTS_DIR / "aggrefill" / "aggrefill-02.jpg",
                   PRODUCTS_DIR / "aggrefill" / "aggrefill-03.jpg"),
     "title": "Pre-coated aggregate filler.",
     "italic": "For damage up to 1 m². Paired with ChipFill for the matrix bond.",
     "callout": "1 m²",
     "callout_unit": "Maximum repair area — combine with ChipFill for permanent torch-cured bond",
     "body": "AggreFill is a pre-coated aggregate filler used in combination with ChipFill to permanently repair the larger potholes — up to approximately 1 m² in diameter. Where the damage is too deep or wide for a stand-alone material, AggreFill provides the structural mass to fill the void; ChipFill bonds the aggregate matrix and seals the repaired surface flush. The combined system applies cold then receives a heat torch finish, bonding chemically to the surrounding substrate and returning the lane to traffic within minutes. Year-round deployment regardless of weather or season. Specified for the deeper road failures, parking lot craters, industrial-site damage, and utility cut restoration where conventional cold-mix migrates under heavy wheel loading.",
     "uses": ["Deep Repair", "Parking Craters", "Utility Cuts", "Industrial"],
     "spec_pairs": [("Type", "Pre-coated aggregate"), ("Pairs with", "ChipFill matrix bond"),
                    ("Repair Size", "Up to ~1 m² in diameter"), ("Cure", "Minutes — open to traffic")]},
    {"name": "Fast Patch",
     "category": "Polymer Cold-Mix Repair",
     "tagline": "Back in service in under an hour.",
     "hero": _pick(PRODUCTS_DIR / "fast-patch" / "fastpatch-repaired.jpg",
                   PRODUCTS_DIR / "fast-patch" / "fastpatch-bucket.jpg"),
     "title": "Cold-mix polymer repair.",
     "italic": "Recycled-polymer blend. Odourless. Suitable for indoor use.",
     "callout": "<45 min",
     "callout_unit": "Cure to return-to-service — Fast Patch Kicker accelerator shortens further in cold",
     "body": "Fast Patch DPR is an easy-to-apply distressed pavement repair material for asphalt and concrete — a unique polymer blend of recycled and renewable materials engineered for high-strength, fast-return-to-service repair of potholes, spalls, joints, wheel paths, and utility cuts. Minimal site prep: clean the area, apply the material, compact — the repaired surface is back in service in under 45 minutes. The optional Fast Patch Kicker accelerator shortens cure further in cooler conditions. Bonds chemically to the substrate with excellent freeze-thaw resistance and impact absorption. Completely odourless — suitable for indoor environments including warehouse floors, loading docks, and underground parkades where ventilation rules out petroleum-based materials.",
     "uses": ["Roads & Bridges", "Trip Hazards", "Parking", "Indoor"],
     "spec_pairs": [("Type", "Polymer-blend cold mix"), ("Return to Service", "<45 minutes"),
                    ("Substrate", "Asphalt and concrete"), ("Odour", "Odourless — indoor-safe")]},
    {"name": "AirMark",
