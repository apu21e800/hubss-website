      ...
      >
        ...
        <div style={{ padding: "24px 28px 32px" }}>
          ...
          <div style={{ marginTop: 24, display: "flex", gap: 12 }}>
            ...
            <a href="/contact" style={{ background: "transparent", color: "#9CA3AF", fontWeight: 600, fontSize: 13, padding: "10px 22px", borderRadius: 8, textDecoration: "none", border: "1px solid rgba(255,255,255,0.12)", display: "inline-flex", alignItems: "center" }}>
              Get a Quote →
            </a>
          </div>
        </div>
